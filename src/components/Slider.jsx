      ...
      >
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 bg-opacity-40 flex flex-col justify-center items-center text-white text-center px-4">
            <h2 className="text-3xl md:text-5xl font-bold">Welcome to HobbyHub</h2>
        ...
        <div className="relative">
          ...
          />
          <div className="absolute inset-0 bg-opacity-40 flex flex-col justify-center items-center text-white text-center px-4">
            <h2 className="text-3xl md:text-5xl font-bold">Virtual Hobby Meetups</h2>
            <p className="mt-2 text-sm md:text-lg max-w-2xl">
        ...
        <div className="relative">
          ...
          />
          <div className="absolute inset-0  bg-opacity-40 flex flex-col justify-center items-center text-white text-center px-4">
            <h2 className="text-3xl md:text-5xl font-bold">Create Your Own Group</h2>
            <p className="mt-2 text-sm md:text-lg max-w-2xl">
